...
$cap = new CheezCap( array(
		new CheezCapGroup( 'Featured Posts', 'firstGroup',
			array(
				new CheezCapBooleanOption(
					'Display Editorial Ad on Homepage?',
					'Well, yes or no?',
					'bool_ad',
					true
				),				
				new CheezCapTextOption(
					'Top Editorial Ad',
					'Add the URL for the image. Don\'t forget the http://.',
					'image_url',
					'http://kits.smrtdsgn.com/wp-content/themes/kits/images/top_kits_mast.png'
				),
				new CheezCapTextOption(
					'Top Editorial Ad Link',
					'Add the URL for the image. Don\'t forget the http://.',
					'link_url',
					'http://makezine.com'
				),
				new CheezCapTextOption(
					'Featured Post #1',
					'This is the primary featured post. Add the post ID of the review that you want to feature.',
					'feat_1',
					'185'
				),
				new CheezCapTextOption(
					'Featured Post #2',
					'This is the second featured post. Add the post ID of the review that you want to feature.',
					'feat_2',
					'4'
				),
				new CheezCapTextOption(
					'Featured Post #3',
					'This is the third featured post. Add the post ID of the review that you want to feature.',
					'feat_3',
					'171'
				),
				new CheezCapTextOption(
					'Site Heading',
					'Verbiage for the site heading. Next to the logo.',
					'heading',
					'Your Trusted Source For Kit Reviews'
				),
				/*new CheezCapTextOption(
					'Text Area Example',
		...
		'themename' => 'Make: Kit Reviews', // used on the title of the custom admin page
